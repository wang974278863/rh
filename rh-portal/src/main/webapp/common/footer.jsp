...
<div id="hp" style="font-size: 12px;color: #333;">
	<a name="weixH"></a>
	<div class="hb center">
		<div class="col-sm-12 col-md-4 tw">
			<ul>
				<li class="col-sm-5">
					<img src="/images/weixin2.png" alt="锐衡教育官方微信" style="width: 100%; max-width: 140px;">
					<p>合肥锐衡教育微信二维码</p>
					<p>微信号：HFQHDQ</p>
				</li>
				<li class="col-sm-5">
					<img src="/images/qq_baoming.png" alt="锐衡教育二维码" style="width: 100%; max-width: 140px;"> 
					<p>合肥锐衡电气培训报名群二维码</p>
					<p>QQ群号：727013424</p>
				</li>
			</ul>
