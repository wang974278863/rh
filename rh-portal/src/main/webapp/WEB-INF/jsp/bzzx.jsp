...
<!-- 				公司概况 -->
			...
			<div class="model-details" style="margin-bottom: 130px;margin-left: 25px;">
				<c:forEach items="${list }" var="obj">
					<div class="news-model">
						<a href="/question/${obj.id }" style="font-size: 14px;color: #333;"><b>${obj.title }</b></a><span>【<fmt:formatDate value="${obj.createDate }" pattern="yyyy-MM-dd"/> 】</span>
						<p>
